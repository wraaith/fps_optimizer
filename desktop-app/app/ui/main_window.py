...
class MainWindow(ctk.CTk):
    def __init__(self):
        ...
        # Solid Samurai Red/Black theme
        self.configure(fg_color="#0a0202")
        ...
        # ── Sidebar ─────────────────────────────────────────────
        self.sidebar = ctk.CTkFrame(self, width=200, corner_radius=0, fg_color="#120404")
        ...
        self.sidebar_label = ctk.CTkLabel(
            ...
            text_color="#d63636"  # Samurai red accent
        )
        self.sidebar_label.pack(pady=(20, 10), padx=10)

        # Samurai themed buttons
        btn_kwargs = dict(
            fg_color="#2b0505", 
            hover_color="#4f0a0a",
            text_color="#e0e0e0"
        ...
        self.scan_button = ctk.CTkButton(
            self.sidebar, text="Scan", command=self.show_scan, **btn_kwargs
        )
        self.scan_button.pack(pady=8, padx=10, fill="x")

        self.predict_button = ctk.CTkButton(
            self.sidebar, text="Predict", command=self.show_predict, **btn_kwargs
        )
        self.predict_button.pack(pady=8, padx=10, fill="x")

        self.history_button = ctk.CTkButton(
            self.sidebar, text="History", command=self.show_history, **btn_kwargs
        )
        ...
        self.overlay_btn = ctk.CTkButton(
            self.sidebar,
            text="▶  Start Overlay",
            fg_color="#8a0303",     # Crimson strike
            hover_color="#590202",
            text_color="#ffffff",
        ...
        # ── Main content area ──────────────────────────────────
        self.main_frame = ctk.CTkFrame(self, fg_color="#140505")
    ...
    def _start_overlay(self):
        ...
        try:
            ...
            self.overlay_btn.configure(
                text="■  Stop Overlay",
                fg_color="#d6831c", # Warning orange
                hover_color="#9e5f11"
            )
            self._overlay_status.configure(text="Overlay: ON", text_color="#d63636")
